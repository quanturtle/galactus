...
down_revision: str | Sequence[str] | None = "6fc47caa4d15"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None


def upgrade() -> None:
    op.alter_column("html_snapshots", "bronze_id", new_column_name="id", schema="bronze")
    op.alter_column("api_snapshots", "bronze_id", new_column_name="id", schema="bronze")
...
def downgrade() -> None:
    ...
    op.alter_column("api_snapshots", "id", new_column_name="bronze_id", schema="bronze")
    op.alter_column("html_snapshots", "id", new_column_name="bronze_id", schema="bronze")
