...
class Parser(BaseParser):
    ...
    ``content_elements`` entry is a full story object. Story bodies live in
    the story's own nested ``content_elements`` (text + raw_html elements).
    Stories without a resolvable headline are skipped (silver.articles
    requires one).
    """
