...
class Parser(BaseParser, ArticleParser):
    ...
    page; each ``content_elements`` entry is a story object whose body
    lives in its own nested ``content_elements``. build_item splits the
    outer feed into one item (story dict) per Article.
    """
